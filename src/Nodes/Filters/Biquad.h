...
private:
  ...
  void calculateCoefficients(const Sample sampleRate,
                             const Sample oneOverSampleRate,
                             const Sample frequency, const Sample resonance,
                             const Sample amplitude, Sample& a0, Sample& a1,
                             Sample& a2, Sample& b0, Sample& b1, Sample& b2);
};
