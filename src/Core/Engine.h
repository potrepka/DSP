...
public:
  ...
  std::vector<unsigned int> getSampleRates(unsigned int inputDevice,
                                           unsigned int outputDevice);

  unsigned int getDefaultInputDevice();
  unsigned int getDefaultOutputDevice();
  unsigned int getDefaultSampleRate(unsigned int inputDevice,
                                    unsigned int outputDevice);

  void setup(unsigned int inputDevice, unsigned int outputDevice,
...
#endif
  static void process(Sample* inputBuffer, Sample* outputBuffer,
                      Engine* engine);
