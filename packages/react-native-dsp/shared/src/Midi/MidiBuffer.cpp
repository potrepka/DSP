...
#ifndef DSP_USE_JUCE
dsp::MidiBuffer::Iterator::Iterator(
    std::multimap<size_t, TimedMidiMessage>::const_iterator it)
    : it(it) {}
...
void dsp::MidiBuffer::addEvents(const MidiBuffer& midiData, size_t startSample,
...
void dsp::MidiBuffer::clear() { events.clear(); }
#endif
