...
std::shared_ptr<dsp::Input> dsp::DryWet::getDry() const { return dry; }

std::shared_ptr<dsp::Input> dsp::DryWet::getWet() const { return wet; }

std::shared_ptr<dsp::Input> dsp::DryWet::getMixAmount() const {
  return mixAmount;
}

std::shared_ptr<dsp::Output> dsp::DryWet::getA() const { return a; }

std::shared_ptr<dsp::Output> dsp::DryWet::getB() const { return b; }
