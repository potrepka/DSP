...
// @ts-ignore
import type { AudioGraphNode } from '../../../dist/classes/AudioGraphNode.js'
// @ts-ignore
import type { TestResult } from '../../../dist/classes/AudioGraphNode.js'
...
const App = () => {
  ...
  const initialize = async () => {
    try {
      ...
      const { AudioGraphNode: AudioGraphNodeClass } =
        // @ts-ignore
        await import('../../../dist/classes/AudioGraphNode.js')
      audioNodeRef.current = await AudioGraphNodeClass.create(
        audioContextRef.current,
        {
          wasmModuleUrl: `${window.location.origin}/web/build/native-audio.js`,
          processorUrl: `${window.location.origin}/dist/classes/AudioGraphProcessor.js`,
        },
      )
  ...
  return (
    ...
    >
      <h1>@potrepka/native-audio React Demo</h1>
      <div
        style={{
          margin: '10px 0',
          padding: '10px',
